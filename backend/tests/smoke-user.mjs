...
if (!generalDeviceResponse.ok || generalDeviceResult.provider !== 'ollama') throw new Error(`General knowledge question was incorrectly blocked as internal data: ${generalDeviceResponse.status} ${JSON.stringify(generalDeviceResult)}`);
