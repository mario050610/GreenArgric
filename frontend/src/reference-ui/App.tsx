...
function MessagesScreen() {
  ...
  const changeMode = (next: "people" | "ai") => { setMode(next); if (next === "ai") setItems([{ sender_id: -1, content: "Xin chào! Bạn có thể hỏi mình về GREEN ARGRIC hoặc bất kỳ chủ đề thông thường nào như học tập, công nghệ, viết nội dung và kiến thức phổ thông.", created_at: new Date().toISOString() }]); else if (selected) void loadConversation(selected); };
